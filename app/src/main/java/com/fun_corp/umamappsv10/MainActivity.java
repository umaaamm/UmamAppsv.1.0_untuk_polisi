...
navigationDrawerLeft.setSelection(position);
                switch (position){
                    case   0:
                        toolbar.setTitle("Lokasi Kecelakaan");
                        break;
                    case   1:
                        toolbar.setTitle("Tentang Apps");
                        break;
                }
            }
       ...
       // navigationDrawerLeft.addItem(new PrimaryDrawerItem().withName("Alkohol").withIcon(getResources().getDrawable(R.mipmap.alkoholblack)));
        navigationDrawerLeft.addItem(new PrimaryDrawerItem().withName("Lokasi Kecelakaan").withIcon(getResources().getDrawable(R.mipmap.ic_location_on_b_48dp)));
      //  navigationDrawerLeft.addItem(new PrimaryDrawerItem().withName("Statistik").withIcon(getResources().getDrawable(R.mipmap.ic_trending_up_black_24dp)));
        navigationDrawerLeft.addItem(new PrimaryDrawerItem().withName("Tentang Apps").withIcon(getResources().getDrawable(R.mipmap.ic_person_b_48dp)));
