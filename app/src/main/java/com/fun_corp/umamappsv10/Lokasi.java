        ...
        try {
            bacadata.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    try {
                       // kecelakaan = dataSnapshot.child("Kecelakaan").getValue().toString();
...
//            lngAnak = 105.277102;
            ...
            try {
                bacadata.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        kecela = dataSnapshot.child("Kecelakaan").getValue().toString();
                            try {
                                markerPoints.clear();
                                googleMap.clear();
                                posAnak = dataSnapshot.child("LatLng").getValue().toString().split(",");
                            ...
                            if (kecela.equals("1")) {
                                notifkece();
                                markerPoints.add(new LatLng(latAnak, lngAnak));
                                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(latAnak, lngAnak)).title("Lokasi Kecelakaan").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_directions_car_black_24dp)));
                            }else {
                                double latitude = gps.getLatitude();
                                double longitude = gps.getLongitude();
                                markerPoints.add(new LatLng(latitude, longitude));
            ...
            if (kecela.equals("1")) {
                notifkece();
                markerPoints.add(new LatLng(latAnak, lngAnak));
                googleMap.addMarker(new MarkerOptions().position(new LatLng(latAnak, lngAnak)).title("Lokasi Kecelakaan").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_directions_car_black_24dp)));
            }else {
                double latitude = gps.getLatitude();
                double longitude = gps.getLongitude();
                markerPoints.add(new LatLng(latitude, longitude));
        ...
        lokasiAnak.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (kecela.equals("1")) {
                    ...
                    Toast.makeText(getActivity(),"Tidak Ada Kecelakaan",Toast.LENGTH_SHORT).show();
                }
                LatLng origin = markerPoints.get(0);
                LatLng dest = markerPoints.get(1);
